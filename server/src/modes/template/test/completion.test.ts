...
suite('HTML Completion', () => {
  test('Complete Start Tag', () => {
    html`<|`.has('iframe').become('<iframe').has('h1').become('<h1').has('div').become('<div');

    html`< |`.has('iframe').become('<iframe').has('h1').become('<h1').has('div').become('<div');

    html`<h|`.has('html').become('<html').has('h1').become('<h1').has('header').become('<header');
  ...
  test('Complete Attribute', () => {
    html`<input |`.has('type').become('<input type="$1"').has('style').become('<input style="$1"').hasNo('onmousemove');

    html`<input t|`.has('type').become('<input type="$1"').has('tabindex').become('<input tabindex="$1"');

    html`<input t|ype`.has('type').become('<input type="$1"').has('tabindex').become('<input tabindex="$1"');

    html`<input t|ype="text"`.has('type').become('<input type="text"').has('tabindex').become('<input tabindex="text"');
  ...
  test('Complete Value', () => {
    html`<input type=|`.has('text').become('<input type="text"').has('checkbox').become('<input type="checkbox"');

    html`<input type="c|`.has('color').become('<input type="color').has('checkbox').become('<input type="checkbox');

    html`<input type="|`.has('color').become('<input type="color').has('checkbox').become('<input type="checkbox');
    ...
    html`<div dir="|"></div>`.has('ltr').become('<div dir="ltr"></div>').has('rtl').become('<div dir="rtl"></div>');
  });
  ...
  test('Case sensitivity', function () {
    html`<LI></|`.has('/LI').become('<LI></LI>').hasNo('/li');
  ...
  test('Settings', function () {
    ...
    noHTML`<|`.has('el-input').withDoc('Input data using mouse or keyboard.').hasNo('div');
    ...
    vueHTML`<|`.has('div').hasNo('el-row').has('component');
